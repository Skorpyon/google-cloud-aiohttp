...
from google.cloud._http import JSONConnection as SyncJSONConnection
...
class JSONConnection(SyncJSONConnection):
    ...
    * :attr:`API_URL_TEMPLATE`
    ...
    async def _make_request(self, method, url, data=None, content_type=None,
        ...
        resp = await self._do_request(method, url, headers, data, target_object)
        return resp

    async def _do_request(self, method, url, headers, data,
    ...
    async def api_request(self, method, path, query_params=None,
