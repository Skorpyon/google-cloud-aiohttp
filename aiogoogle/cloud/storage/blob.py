...
from aiogoogle.cloud.storage.acl import ObjectACL
...
class Blob(_PropertyMixin):
    ...
    async def delete(self, client=None):
        ...
        """
        resp = await self.bucket.delete_blob(self.name, client=client)
        return resp

    async def download_to_file(self, file_obj, client=None):
